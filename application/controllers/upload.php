...
class Upload extends CI_Controller
{
    ...
    {
        $upload_path_url = base_url() . 'assets/images/';
    ...
    { //gets the job done but you might want to add error checking and security
        $success = unlink(FCPATH . 'assets/images/' . $file);
        $success = unlink(FCPATH . 'assets/images/thumbs/' . $file);
        //info to see if it is doing what it is supposed to
        $info = new StdClass;
        $info->sucess = $success;
        $info->path = base_url() . 'assets/images/' . $file;
        $info->file = is_file(FCPATH . 'assets/images/' . $file);
