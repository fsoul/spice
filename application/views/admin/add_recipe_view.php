<div class="container">
<div>
    <a href="/index.php/admin/view/recipes/">Список рецептов</a> > <span>Добавление рецепта</span>
</div>
<hr/>
<form enctype="multipart/form-data" method="post" action="/index.php/admin/add/recipe/">
...
<div class="panel-group" id="accordion2" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
        ...
        <div id="collapseDescRu" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="descRu">
            <div class="panel-body area-view">
                <textarea name="description_ru" id="description_ru"></textarea>
            </div>
        </div>
    </div>
    <div class="panel panel-default">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapseDescDe" class="panel-collapse collapse" role="tabpanel" aria-labelledby="descDe">
            <div class="panel-body area-view">
                <textarea name="description_de" id="description_de"></textarea>
            </div>
        </div>
    </div>
</div>
...
<div class="panel-group" id="accordion3" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
        ...
        <div id="collapseIngrRu" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="ingrRu">
            <div class="panel-body area-view">
                <textarea name="ingridients_ru" id="ingridients_ru"></textarea>
            </div>
        </div>
    </div>
    <div class="panel panel-default">
        ...
        <div id="collapseIngrEn" class="panel-collapse collapse" role="tabpanel" aria-labelledby="ingrEn">
            <div class="panel-body area-view">
                <textarea name="ingridients_en" id="ingridients_en"></textarea>
            </div>
        </div>
    </div>
    <div class="panel panel-default">
        ...
        <div id="collapseIngrDe" class="panel-collapse collapse" role="tabpanel" aria-labelledby="ingrDe">
            <div class="panel-body area-view">
                <textarea name="ingridients_de" id="ingridients_de"></textarea>
            </div>
        </div>
    </div>
</div>
