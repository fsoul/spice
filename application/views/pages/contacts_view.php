<div id="contacts_main" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="contacts_left_block pull-left">
        ...
        <p class="c_link"><a href="http://ok.ru/<?= $link; ?>"><?= $link; ?></a></p>
    </div>
    <div class="c_callback_form pull-left">
            ...
            <form class="c_form" method="post" action="/contacts/send">
                <p>
                    <input class="c_input" placeholder="<?= $name[$lang]; ?>" type="text" name="c_name"/>
                </p>
                <p>
                    <input class="c_input" placeholder="<?= $email[$lang]; ?>" type="text" name="c_mail"/>
                </p>
                <textarea class="c_msg" placeholder="<?= $msg[$lang]; ?>" name="c_msg"></textarea>
